  ...
  return (
    <section className="main-section">
      <Container>
        ...
        >
          Call your<span className="text-primary">Home Wiring </span> Serviceworker easily !
        </h3>
        <Row>
        <Col md={4} className="shadow-lg p-3 mb-5 bg-white rounded cardBody">
            <Card>
              ...
              />
              <Card.Body>
                <Card.Title><span className="text-primary">Name - </span>John Doe</Card.Title><hr/>
                <Card.Text>
                <div><span className="text-primary">Mobile No. - </span>123-456-789</div>
                <div><span className="text-primary">Area. - </span>Lucknow</div>
                </Card.Text>
          ...
          <Col md={4} className="shadow-lg p-3 mb-5 bg-white rounded cardBody">
            <Card>
              ...
              />
              <Card.Body>
                <Card.Title><span className="text-primary">Name - </span>John Doe</Card.Title>
                <Card.Text>
